...
Vsechny nasledujici rovnice predpokladaji, ze pocatek lezi na ose otaceni
\cor{Moment hybnosti}{$L=r \times p$}
\frm{
...
\cor{Moment sily}{$\frac{\diff L}{\diff t} = M$ \hspace{10cm}... ekvivalentni s $\frac{\diff p}{\diff t}=F$}
...
\end{wrapfigure}%
\begin{align*}
  &dL=r \times p \text{, } dp = vdm=(w \times r)dm \\
...
\cor{Moment setrvacnosti}{$L_i=I_{ij}w_j$}
...
\textbf{Hlavni osy tuheho telesa}, kde osa otaceni prochazi tezistem
\frm{
...
\animategraphics[height=2.8in,autoplay,controls]{12}{images/wow/wow-}{0}{18} \\
\animategraphics[autoplay,controls,loop,scale=1]{12}{images/wow/wow-}{0}{18}
... epicka magie, ktere nerozumim 
\newpage
